...
class RunnerConfig:
    ...
    def __init__(self):
        ...
        self.TARGET_SYSTEM  = os.getenv(f'SYS2')
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        llm = FactorModel("llm", ['gpt-4'])
        code = FactorModel("code", ['4'])
        self.run_table_model = RunTableModel(
            factors = [sampling_factor, llm, code],
            exclude_variations = [
                {llm: ['wizardcoder'], code: ['16', '63', '79', '90']},
                {llm: ['code-millenials'], code: ['90']},
                {llm: ['deepseek-coder'], code: ['79']},
                {llm: ['gpt-4'], code: []},
                {llm: ['chatgpt'], code: []},
                {llm: ['speechless-codellama'], code: ['52', '61', '90']},
            ],
    ...
    def start_measurement(self, context: RunnerContext) -> None:
        ...
        profiler_cmd = f'source .exp-venv/bin/activate && \
                        sudo -S energibridge \
